...
include	$(ROOT_DIR)/Makefile.d/config/lib-defaults.mk
...
include	$(ROOT_DIR)/Makefile.d/rules/libs/header.mk
include	$(ROOT_DIR)/Makefile.d/rules/libs/name.mk
include	$(ROOT_DIR)/Makefile.d/rules/shared/objs.mk
include	$(ROOT_DIR)/Makefile.d/rules/shared/build-static.mk
include	$(ROOT_DIR)/Makefile.d/rules/libs/clean.mk
include	$(ROOT_DIR)/Makefile.d/rules/libs/fclean.mk
